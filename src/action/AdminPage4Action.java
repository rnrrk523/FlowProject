...
public class AdminPage4Action implements Action{
	@Override
...
//		int memberIdx = Integer.parseInt(request.getParameter("memberIdx"));
		...
		char dFuncYN = 'N';
		try {
			dFuncYN = cDao.getDepartmentFuncYN(companyIdx);
		} catch (Exception e) {
		...
		request.getRequestDispatcher("flow_admin4.jsp").forward(request, response);
	}
}