...
/**
 * Servlet implementation class TaskGroupSetAjax
 */
@WebServlet("/TaskGroupSetAjax")
public class TaskGroupSetAjax extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(taskGroupIdx != 0) {
			try {
				dao.UpdateTaskGroup(taskGroupIdx,taskIdx);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
