...
@WebServlet("/ChatCompanyMemberSearchAjax")
public class ChatCompanyMemberSearchAjax extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<MemberDto> list2 = null;
		try {
			list = dao.CompanyMemberSearch(companyIdx, text);
		} catch (Exception e) {
			e.printStackTrace();
		}
