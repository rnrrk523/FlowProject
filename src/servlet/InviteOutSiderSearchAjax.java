...
/**
 * Servlet implementation class InviteOutSiderSearchAjax
 */
@WebServlet("/InviteOutSiderSearchAjax")
public class InviteOutSiderSearchAjax extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			list = dao.OutSiderMemberSearch(companyIdx,memberIdx,search);
		} catch (Exception e) {
			e.printStackTrace();
		}
