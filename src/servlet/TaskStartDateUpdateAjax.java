...
/**
 * Servlet implementation class TaskStartDateUpdateAjax
 */
@WebServlet("/TaskStartDateUpdateAjax")
public class TaskStartDateUpdateAjax extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			dao.UpdateStartDate(date,taskIdx);
		} catch (Exception e) {
			e.printStackTrace();
		}
