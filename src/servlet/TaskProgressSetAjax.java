...
/**
 * Servlet implementation class TaskProgressSetAjax
 */
@WebServlet("/TaskProgressSetAjax")
public class TaskProgressSetAjax extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			dao.UpdateProgress(progress,taskIdx);
		} catch (Exception e) {
			e.printStackTrace();
		}
